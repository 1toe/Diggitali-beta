...
export default function FirebaseDiagnostic() {
  ...
  useEffect(() => {
    const checkFirebaseConfig = async () => {
      ...
      try {
        // Import Firebase dynamically to check initialization
        ...
        const configComplete = !!(
          ...
          true // usando valores hardcodeados en el config
        )
        ...
        // Try to get Firebase config for debugging
        if (app) {
          setConfig({
            projectId: "ludicocos-e4bcc",
            authDomain: "ludicocos-e4bcc.firebaseapp.com",
            apiKey: "AIzaSyAD***", // Ocultar por seguridad
          })
        }
